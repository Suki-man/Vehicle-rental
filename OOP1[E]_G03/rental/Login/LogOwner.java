...
public class LogOwner implements ActionListener {
    ...
    public LogOwner() {
        ...
        JLabel ownerlLabel = new JLabel("OWNER LOGIN");
        ownerlLabel.setBounds(900, 30, 300, 30);
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (parts[1].equals(email) && parts[2].equals(password)) {
                    In = true;
                    user = new UserOwner(parts[0], parts[1], parts[2]);
                    break;
                }
            }
            reader.close();
